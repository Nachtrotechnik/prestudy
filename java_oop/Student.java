...
public class Student extends Person {
    ...
    public void learn(Person person, String topic) {
        System.out.println("Student " + this.getId() + " is learning " + topic + " from " + person.getClass().getSimpleName());
    ...
    public void teach(Person person, String topic) {
        System.out.println("Student " + this.getId() + " is teaching " + topic + " to " + person.getClass().getSimpleName());
