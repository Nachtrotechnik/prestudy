 ...
 */
public class Teacher extends LearnPerson {
    ...
    public void teach(PersonType personType, String topic) {
        System.out.println("Teacher " + this.getId() + " is teaching " + topic + " to " + personType.getClass().getSimpleName());
    ...
    public void learn(PersonType personType, String topic) {
        System.out.println("Teacher " + this.getId() + " is learning " + topic + " from " + personType.getClass().getSimpleName());
